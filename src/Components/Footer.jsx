  ...
  return (
    <div className="py-8 bg-black text-white w-full">
      <div className="items-center py-8">
        <h1 className="lg:text-2xl md:text-2xl sm:text-xl text-white uppercase px-4">
          Noiceland
        ...
        <div className="md:grid gap-5 grid-cols-6 px-3 items-center justify-center">
          ...
          <div className="md:flex w-full h-8 col-span-2 items-center flex-col md:flex-row">
            <input
              ...
              className="rounded p-3 w-[100%] text-black"
            />
            <a
              href="#"
              type="submit"
              className="md:p-3 bg-blue-500 text-center rounded w-[100%] mt-4 md:mt-0 md:w-[50%]"
            >
              Submit
            </a>
          </div>
      ...
      <div className="md:grid gap-5 grid-cols-6 p-8 items-center justify-center mt-4 text-center">
        <div className="item">
          <h4 className="text-gray-500 py-4 lowercase px-3 text-center">
            INFORMATION
          </h4>
