      ...
      <div className="w-full bg-white max-w-[1240px] mx-auto px-8 mt-4 sticky top-0 items-center">
        <div className="flex justify-between items-center text-center w-full border-b">
          ...
          <div
            ...
            className=" md:hidden  block absolute top-5 right-5"
          >
            {isOpen ? (
          ...
          <div>
            <ul className="hidden md:flex items-center">
              <li className="p-4 uppercase text-black text-xl">
                <Link to="/" className="hover: border-b-black">
                  Home
                </Link>
              </li>
              <li className="p-4 uppercase text-black text-xl">
                <Link to="/latest" className="hover: border-b-black">
                  Latest
                </Link>
              </li>
              <li className="p-4 uppercase text-black text-xl">
                <Link to="/about" className="hover: border-b-black">
                  About
                </Link>
              </li>
            </ul>
